      ...
      <div className="container mx-auto px-6 md:px-12 lg:px-24 relative z-10 text-center">
        ...
        >
          ...
          <div className="flex flex-wrap items-center justify-center gap-4">
            <Link 
              href="https://apps.apple.com/kr/app/kolektt/id6743063796"
              target="_blank"
              className="group/btn relative flex items-center px-6 py-3 rounded-xl border-none min-w-[200px] hover:scale-105 active:scale-95 cursor-pointer shadow-lg transition-all overflow-hidden bg-white text-black hover:bg-gray-200"
            >
