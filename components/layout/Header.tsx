            ...
            >
              {navLinks.map((link) => (
                link.comingSoon ? (
                  <span
                    key={link.name}
                    className="text-2xl font-bold font-sans relative group cursor-not-allowed text-primary/50"
                  >
                    {link.name}
                    <span className="absolute -top-8 left-1/2 -translate-x-1/2 px-2 py-1 rounded text-xs font-medium whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none bg-primary text-white">
                      {language === "KO" ? "준비중" : "Coming Soon"}
                    </span>
                  </span>
                ) : (
              ...
              <div className="flex flex-col gap-4">
                <button
                  onClick={toggleLanguage}
                  className="px-8 py-3 bg-primary text-white text-lg font-bold rounded-full flex items-center gap-2 justify-center cursor-pointer"
                >
                ...
                <button
                  onClick={toggleTheme}
                  className="p-3 bg-primary text-white text-lg font-bold rounded-full cursor-pointer flex items-center justify-center"
                  aria-label="Toggle theme"
                >
