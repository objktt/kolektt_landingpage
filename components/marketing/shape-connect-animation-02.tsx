...
interface ShapeConnectAnimation02Props {
  theme?: 'light' | 'dark';
}

export const ShapeConnectAnimation02 = ({ theme = 'light' }: ShapeConnectAnimation02Props) => {
    ...
    <section ref={ref} className={cn("relative py-20 lg:py-32 overflow-hidden -mt-[150px]", bgClass)}>
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mt-8">
          <p className={cn("text-sm font-medium", textClass)}>We cultivate possibility</p>
        </div>
